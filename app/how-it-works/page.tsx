        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-zinc-400">
              Learn how we protect your environment while ensuring your report
          ...
          <div className="mt-24 grid gap-12">
            {[
              ...
              },
              {
                ...
                description:
                  "Use map to get the latitude and longitude of any location and copy the their value and paste it in the location inputs. Use this method if your are not in the right location where the leakage happens.",
                icon: <MapIcon className="h-6 w-6 text-sky-400" />,
              },
              {
                step: "03",
                title: "Get Secured Code",
                description:
                  "After submitting the for you will get a code, and use that code to track the report weather the project is resolve or not.",
                icon: (
                  <svg
                    className="h-6 w-6 text-sky-400"
                    fill="none"
              ...
              },
              {
                ...
                description:
                  "If needed, Our admins will communicates you if you want direct call using the emergency number with is 911.",
                icon: (
                  <svg
                    className="h-6 w-6 text-sky-400"
                    fill="none"
